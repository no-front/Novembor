...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ URL('css/font-awesome/css/all.css') }}">
	<!-- <link rel="stylesheet" type="text/css" href="{{ URL('css/app.css') }}"> -->
	<link rel="stylesheet" type="text/css" href="{{ URL('fonts/fonts.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ URL('css/novembor.css') }}">
...
<body>
			...
			<div class="container font-white">
				<div class="row mlr-sx-0">
					<div class="col-md-6 col-sm-6 col-6 pl-0 pl-sm-2">
						<a href="{{ URL('/') }}">
							<img src="{{ URL('img/logo-novembor-white.png') }}" class="logo-banner">
						</a>
					</div>
						...
						<div class="block-right-main" align="center">
							<div class="row align-middle">
								...
								<div class="col">
									...
									<!-- @if(Auth::User())
										<a href="{{ URL('profile') }}" class="font-white">
											โปรไฟล์
										</a>
									@else
										<a href="{{ URL('login') }}" class="font-white">
											เข้าสู่ระบบ
										</a>
									@endif -->
								</div>
					...
					<div class="row">
						<div class="col-md-4 col-sm-5 col-7 block-top-menu font-lg-14 font-xs-12">
							<div class="row" align="center">
								<div class="col plr-md-0">
									<a href="{{ URL('listproduct/alone') }}">
										ทานเดี่ยว
									</a>
									<div class="line-top-menu">|</div>
								</div>
								<div class="col plr-md-0">
									<a href="{{ URL('listproduct/duo') }}">
										ทานคู่
									</a>
									<div class="line-top-menu">|</div>
								</div>
								<div class="col plr-md-0">
									<a href="{{ URL('listproduct/group') }}">
										ทานกลุ่ม
									</a>
								</div>
							</div>
						...
						<div class="col-md-5 col-sm-4 col-4 block-top-menu font-lg-12 textoverflow d-none d-sm-none d-md-block">
							<div class="inline-block pr-md-50 relative textoverflow width70pc">
								...
								<a class="btn-change-location" href="{{ URL('marklocation') }}">
									เปลี่ยน
								</a>
							</div>
						</div>
								   		...
								   		<div class="col-12 font-weight-bold mt-md-2 mt-2 font-lg-20">
								   			<div class="row mx-md-0 mx-0">
								   				<div class="col-12 px-md-0 px-0" align="center">
								   					...
								   					<input type="hidden" id="urlmarklocation" value="{{ URL('marklocation') }}" hidden>
								   					<input type="hidden" id="urlmyorder" value="{{ URL('myorder') }}" hidden>
								   					<input type="hidden" id="urlhome" value="{{ URL('/') }}" hidden>
								   				</div>
								   			</div>
								   		</div>
								   	</div>
	...
	<script type="text/javascript" src="{{ URL('js/novembor/main.js') }}"></script>
