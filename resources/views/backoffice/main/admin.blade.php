...
<body>
		...
		<div class="container mh-100">
			<div class="row mt-md-5">
				<div class="col-6 offset-md-3 bg-white bg-shadow px-md-4 py-md-4">
						...
						<div class="row px-md-4 pb-md-2">
							<div class="col-12">
			  					<div class="form-group">
			    					...
			    					@if(isset($error))
			    						<div id="responseEmail" class="text-danger pt-md-2 font-lg-14">{{ $error }}</div>
			    					@endif
			  					</div>
							...
							<div class="col-12 mb-md-4">
			  					<div class="form-group">
			    					...
			    					@if(isset($error))
			    						<div id="responsePass" class="text-danger pt-md-2 font-lg-14">{{ $error }}</div>
			    					@endif
			  					</div>
							</div>
					...
					<!-- @if(isset($error))
						<input type="" id="response" onchange="response(this)" value="{{ $error }}">
					@endif -->
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="{{ URL('js/backoffice/adminlogin.js') }}"></script>
</body>
</html>