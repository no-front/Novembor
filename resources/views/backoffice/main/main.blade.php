...
<head>
	...
	<script src="{{ URL('js/push-notification/push.js') }}"></script>

	<script src="{{ URL('js/backoffice/main.js') }}"></script>
			...
			<div class="container font-white">
				<div class="row">
					...
					<div class="col pt-md-4" align="right">
						<a href="{{ URL('/admin/logout') }}">ออกจากระบบ</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-md-3 bg-backoffice border-aaa mh-100">
					<div class="row">
						...
						<div class="col-12 py-md-2 block-main-menu" id="block-main-menu-2">
							<a href="{{ URL('admin/orderinformation') }}">
