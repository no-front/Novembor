...
@section('content')
		...
		<div class="col">
			...
			<div class="row mx-md-0">
				<div class="col bg-f0f0f0 py-md-3 mb-md-5">
					<form action="{{ URL('admin/addproductdata/data') }}" method="post" enctype="multipart/form-data">
			  			...
			  			<div class="row">
			  				<div class="col-6">
			  					<div class="form-group">
			    					...
			    					<a id="actionUpload">
			    						<img src="{{ URL('img/addImage.jpg') }}" id="output" class="w-100 border-1-ddd">
			    					</a>
	...
	<script type="text/javascript" src="{{ URL('js/backoffice/addproduct.js') }}"></script>
